...
import { getArtistDetail, getArtistTopTracks } from "@/lib/spotify/artistService";
...
export default function ArtistPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const [artistData, topTracks] = await Promise.all([getArtistDetail(id), getArtistTopTracks(id)]);
